...
export class Chat {
    ...
    constructor(private social: SocialSharing, public popoverCtrl: PopoverController, private camera: Camera, public profileData: ProfileData, public navCtrl: NavController, public navParams: NavParams, public eventData: EventData, private toast: ToastController) {
